...
/** @type {string} */
const CACHE_VERSION = '1744848182|883284886';
/** @type {string} */
const CACHE_PREFIX = 'FlipGoUp-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'FlipGoUp.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["FlipGoUp.html","FlipGoUp.js","FlipGoUp.offline.html","FlipGoUp.icon.png","FlipGoUp.apple-touch-icon.png","FlipGoUp.audio.worklet.js","FlipGoUp.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["FlipGoUp.wasm","FlipGoUp.pck"];
